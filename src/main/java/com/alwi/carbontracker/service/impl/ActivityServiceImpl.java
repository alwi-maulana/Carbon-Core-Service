...
public class ActivityServiceImpl implements ActivityService {
    ...
    @Transactional
    @Override
    public List<DailyEmissionSummaryDTO> fetchDailySummary(DateDTO date) throws ValidationException {
        try {
            return carbonEmissionResultRepository.getDailySummary(date.getDate());
        } catch (DataAccessException e) {
